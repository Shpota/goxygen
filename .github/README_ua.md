...
Goxygen зберігає ваш час при створенні нових проетів. Він
...
## Структура згенерованого проеткту
    ...
    ├── .gitignore
    └── README.md                # інтсрукція по використанню проекту
...
використання специфічних біблотек чи утиліт. Згенерований проект
...
Якщо хочете запропнувати зміни - можете обговорити їх 
[в нашому Gitter чаті](https://gitter.im/goxygen/community) або
